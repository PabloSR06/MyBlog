        ...
        <header>
            <div className={styles.headerContainer}>
                <ul className={styles.headerSocials}>
                    <li>
                        <a className={styles.headerLinkSocial} href="/public">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                 className="bi bi-house header-icon-social" viewBox="0 0 16 16" width="16"
                                 height="16"
                    ...
                    <li>
                        <a className={styles.headerLinkSocial} href={LinkedinUrl} target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                 className="bi bi-linkedin header-icon-social" viewBox="0 0 16 16" width="16"
                                 height="16" aria-label="Linkedin Icon">
                                <path
                    ...
                    <li>
                        <a className={styles.headerLinkSocial} href={TwitterUrl} target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                 className="bi bi-twitter header-icon-social" viewBox="0 0 16 16" width="16" height="16"
                    ...
                    <li>
                        <a className={styles.headerLinkSocial} href="" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                 className="bi bi-github header-icon-social" viewBox="0 0 16 16" width="16" height="16"
                    ...
                    <li>
                        <a className="header-link-social" href={BuyMeACoffeeUrl} target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                 className="bi bi-cup-hot-fill header-icon-social" viewBox="0 0 16 16"
                                 aria-label="BuyMeACoffee Icon">
